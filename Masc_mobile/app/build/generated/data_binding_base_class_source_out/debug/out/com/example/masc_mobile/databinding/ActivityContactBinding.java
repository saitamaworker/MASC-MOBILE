...
public final class ActivityContactBinding implements ViewBinding {
  ...
  private ActivityContactBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout contact, @NonNull TextView textView) {
  ...
  public static ActivityContactBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout contact = (ConstraintLayout) rootView;
      ...
      return new ActivityContactBinding((ConstraintLayout) rootView, contact, textView);
    }
