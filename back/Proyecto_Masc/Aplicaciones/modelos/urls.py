...
from .views import RegisterView, LoginView, LogoutView, UsuarioViewSet, CategoriaViewSet, SubcategoriaViewSet, ProductoViewSet, index, dashboard, login_view, register_view
